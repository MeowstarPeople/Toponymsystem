...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    // 刷新回调接口
    private static OnPullToRefreshListener mListener;
    // 刷新成功
    ...
    public static void setOnRefreshListener(OnPullToRefreshListener listener) {
        mListener = listener;
    }
...
//                loadStateImageView.setBackgroundResource(R.drawable.load_failed);
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            ...
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateTextView.setText("释放更新");
            ...
            case REFRESHING:
                ...
                mLoadAnim.start();
                refreshStateTextView.setText("加载中...");
                break;
            case RELEASE_TO_LOAD:
                // 释放加载状态
                loadStateTextView.setText("立即加载");
    ...
    private void initView() {
        ...
        refreshingView.setBackgroundResource(R.drawable.refresh_loading);
        mLoadAnim = (AnimationDrawable) refreshingView.getBackground();
        // 初始化上拉布局
        pullUpView = loadMoreView.findViewById(R.id.pullup_icon);
        loadStateTextView = (TextView) loadMoreView.findViewById(R.id.loadState);
